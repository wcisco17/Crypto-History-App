...
type MONTH = '1MTH' | '2MTH' | '3MTH' | '4MTH'
type YEAR = '1YRS' | '2YRS' | '3YRS' | '4YRS'
type DAY = '1DAY' | '2DAY' | '3DAY' | '5DAY' | '7DAY' | '10DAY'
type HOUR = '1HRS' | '2HRS' | '3HRS' | '4HRS' | '6HRS' | '8HRS' | '12HRS'
...
export type CoinMarketCapData = { [key: string]: CoinMarketCapApiReturnType; }
